...
// // 1. У стрелок нет своего «собственного» this и super. Стрелочная функция не может быть методом обьекта.
////     С ними не работают методы call, apply и bind, которые обычно основываются на установлении области действия.
// // 
...
// // При использовании колбэков внутри методов мы уверены, что стрелочная функция не определяет сама по себе this.
...
// // // 2. Следствием лексического разрешения является то, что стрелочную функцию нельзя использовать
...
// // // Если нам нужно получить доступ к прямым аргументам функции стрелки, нужно использовать
// // //...args параметр, который собирает аргументы стрелочной функции: {0: 'c', 1: 'd'}.
// //
// // function myRegularFunction() {
...
// // и тогда эта функция возвращается неявно.
//
// const increment = (num) => num + 1;
// increment(41); // => 42

// 5. Стрелочные функции всегда анонимны.
